...
/*    public TaskSecondSendAnOrder GoToMenuRoll() {
 ...
 /*   public TaskSecondSendAnOrder FuckingClick()        WebElement FuckClick = driver.findElement(By.className("mfp-wrap mfp-close-btn-in mfp-auto-cursor my-mfp-zoom-in mfp-ready"));
        FuckClick.click();
        return this;
    }*/
    ...
    public TaskSecondSendAnOrder MathRandomHead (){
        List<WebElement> list = driver.findElements(By.xpath("//a[contains(@class, \"scroll-nav_link\") and not (contains(@href, \"/menu/pizza\")) and not (contains(@href, \"/menu/konstruktor-polovink\")) and not (contains(@href, \"/menu/kombo\")) ]"));
